...
export const metadata: Metadata = {
  title: "Image Compressor, Image Converter and PDF Tools Online",
  description:
    "India's best free image compressor — compress to 20KB, 50KB, 100KB for SSC, UPSC, KYC forms. Convert JPG PNG WEBP, AI background removal, and 50+ online tools.",
  alternates: {
    canonical: "/",
  },
  openGraph: {
    title: `Image Compressor, Converter and PDF Tools Online | ${SITE_NAME}`,
    description:
  ...
  twitter: {
    ...
    title: `Image Compressor & Converter Online India | ${SITE_NAME}`,
    description:
      "Free image compressor for 20KB and 100KB uploads, AI tools, format conversion, and PDF workflows.",
...
const homeFaq = [
  {
    question: "What tools are available on ImageFormatConverter?",
    answer: "ImageFormatConverter includes image compressor, resizer, converter, crop, bulk compression, rotate and flip, AI background remover, image upscaler, metadata remover, and 50+ SEO-friendly workflow pages for India.",
  },
  {
  ...
  {
    question: "Does ImageFormatConverter store uploaded files?",
...
const aiSeoPages = intentPages.filter((page) =>
  page.slug.startsWith("ai-") || page.slug.startsWith("chatgpt-") || page.slug.startsWith("free-ai-")
);
      ...
      <main className="landing hub-page">
        <section className="hero">
          <div className="hero-inner section-content">
            <span className="badge-pill">India&apos;s #1 image compressor — 50+ free tools</span>
            <h1 className="hero-title">Best Image Compressor Online in India</h1>
            <p className="hero-subtitle">
              Compress photos to 20KB, 50KB, and 100KB for SSC, UPSC, KYC, and job forms.
              Convert JPG PNG WEBP, remove backgrounds with AI tools, and download instantly — no signup.
            </p>
        ...
        <section className="section">
          <div className="section-content">
            <h2 className="section-heading">AI Image Tools for Search &amp; Upload Workflows</h2>
            <div className="intent-link-grid">
              {aiSeoPages.map((page) => (
                <Link key={page.slug} href={`/${page.slug}`} className="intent-link-card">
                  <strong>{page.title.split("|")[0].trim()}</strong>
