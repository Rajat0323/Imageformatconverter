...
export const toolPages: ToolPage[] = [
  ...
  },
  {
    ...
    category: "image",
    mode: "compressor",
    title: "Compress Image to 50KB Online | Free Photo Size Reducer for Forms",
    description:
      "Compress image to 50KB online free for SSC, UPSC, job forms, passport photos, and student portal uploads in India. Fast browser-based JPG PNG WEBP compression.",
    keywords: [
      "compress image to 50kb",
      "photo compressor 50kb",
      "reduce image size to 50kb",
      "50kb image converter online",
      "compress image to 50kb online",
      "compress image to 50kb for government form",
      "compress image for SSC form",
      "photo compressor to 50kb",
      "jpg compress to 50kb",
    ],
    ...
    featureList: [
      ...
      "SSC, UPSC, and job portal ready",
    ],
    faqList: [
      {
        question: "Can I reduce a passport photo to 50KB?",
        answer: "Yes. Upload the file and use this preset to reduce the image toward a 50KB result for portal submissions.",
      },
      {
        question: "Which format is best for 50KB?",
        answer: "JPG is usually the easiest way to keep quality while staying near 50KB. WEBP can also work well for newer browsers.",
      },
      {
        question: "Does it support PNG images?",
        answer: "Yes. You can upload PNG files and compress them directly or switch the output to JPG or WEBP for smaller size.",
      },
      {
        question: "Can I use this for SSC and UPSC exam forms?",
        answer: "Yes. Many Indian exam portals accept photos around 50KB. Verify the exact limit on your form before final upload.",
      },
      {
        question: "Can I use the tool on mobile data?",
        answer: "Yes. The interface is light, touch friendly and works well on Android and iPhone browsers.",
      },
    ],
    defaultTargetKB: 50,
    homeFeatured: true,
